...
board_t init_board(board_t b, player_t white, player_t black); // returns a board_t as it is at the beginning of the game
...
int does_rook_see_king(board_t b, int from_i, int from_j, char direction,char *checking_direction); // helper functions for check_for_check function
int does_bishop_see_king(board_t b, int from_i, int from_j, char direction,char *checking_direction);

int check_for_check(board_t b, int player_to_be_checked,char *checking_direction,square_t *checking_piece); // check if the player with color player_to_be_checked is in check, 
...
board_t make_move(board_t b, char from_col, int from_row, char to_col, int to_row, int *move_succesfull,char *checking_direction,square_t *checking_piece); // moves a piece to an empty square, replaces the piece's starting square with an empty square
board_t take_piece(board_t b, char from_col, int from_row, char to_col, int to_row, int *move_succesfull,char *checking_direction,square_t *checking_piece); // capture a piece, replaces the capturing piece's starting square with an empty square
board_t promote(board_t b, int color, char from_col, int from_row, char to_col, int to_row, int *move_succesfull,char *checking_direction,square_t *checking_piece); // promotes a pawn to a queen
...
int check_for_checkmate(board_t b, int player_color,char *checking_direction,square_t *checking_piece); // now implemented, its really quite literal
