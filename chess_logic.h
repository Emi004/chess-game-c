...
void make_move(board_t *b, char from_col, int from_row, char to_col, int to_row, int *move_succesfull,char *checking_direction,square_t *checking_piece); // moves a piece to an empty square, replaces the piece's starting square with an empty square
void take_piece(board_t *b, char from_col, int from_row, char to_col, int to_row, int *move_succesfull,char *checking_direction,square_t *checking_piece); // capture a piece, replaces the capturing piece's starting square with an empty square
void promote(board_t *b, int color, char from_col, int from_row, char to_col, int to_row, int *move_succesfull,char *checking_direction,square_t *checking_piece); // promotes a pawn to a queen
